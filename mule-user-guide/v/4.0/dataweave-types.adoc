...
| link:/mule-user-guide/v/4.0/dataweave-core-functions#typeOf[typeOf] |('Any')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#as-(type-coercion)[as] |('Any', 'Type')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#push[+] |('Any', 'Array')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sum[+] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#minus[-] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#multiply[*] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#division[/] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#round[round] |('Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sqrt[sqrt] |('Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#pow[pow] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#ceil[ceil] |('Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#floor[floor] |('Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#abs[abs] |('Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#mod[mod] |('Number', 'Number')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#ordinalize[ordinalize] |('Number')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#min[min] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#max[max] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sizeof[sizeOf] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sum[sum] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#flatten[flatten] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#orderby[orderBy] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#reduce[reduce] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#array-push[+] |('Array', 'Any')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#array-remove[-] |('Array', 'Any')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#array-remove-all[--] |('Array', 'Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#map[map] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#avg[avg] |('Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#filter[filter] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#contains[contains] |('Array', 'Any')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#distinctby[distinctBy] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#joinby[joinBy] |('Array', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#using-oncat-on-an-array[++] |('Array', 'Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#groupby[groupBy] |('Array', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#ziparrays[zip] |('Array', 'Array')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#unziparray[unzip] |('Array')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#trim[trim] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#using-concat-on-a-string[++] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sizof[sizeOf] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#capitalize[capitalize] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#lower[lower] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#upper[upper] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#camelize[camelize] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#dasherize[dasherize] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#underscore[underscore] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#singularize[singularize] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#pluralize[pluralize] |('String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#split-by[splitBy ] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#split-by[splitBy] |('String', 'Regex')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#find[find] |('String', 'Regex')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#find[find] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#replace[replace] |('String', 'Regex', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#startswith[startsWith] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#endswith[endsWith] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#match[match] |('String', 'Regex')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#matches[matches] |('String', 'Regex')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#scan[scan] |('String', 'Regex')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#contains[contains] |('String', 'String')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#contains[contains] |('String', 'Regex')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#sizeof[sizeOf] |('Object')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#orderby[orderBy] |('Object', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#using-map-on-an-object[map] |('Object', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#map-object[mapObject] |('Object', 'Function')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#using-oncat-on-an-object[++] |('Object', 'Object')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#using-remove-on-an-object[-] |('Object', 'Name')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#remove-by-matching-key-and-value[--] |('Object', 'Object')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#pluck[pluck] |('Object', 'Function')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#shift-time-zone[>>] |('Datetime', 'Timezone')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[+] |('Datetime', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-a-period-of-time[-] |('Datetime', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-two-dates[-] |('Datetime', 'Datetime')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-two-dates[-] |('Date', 'Date')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time[++] |('Date', 'Localtime')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time[++] |('Date', 'Time')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time-zone[++] |('Date', 'Timezone')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[+] |('Date', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[-] |('Date', 'Period')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-two-dates[-] | ('#Time', 'Time')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time[++] | ('#Time', 'Date')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[+] | ('Time', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[-] | ('Time', 'Period')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-two-dates[-] |('Localtime', 'Localtime')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time[++] |('Localtime', 'Date')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time-zone[++] |('Localtime', 'Timezone')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[+] |('Localtime', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[-] |('Localtime', 'Period')
|===
...
|===
| Operator| Accepted types for each argument
| link:/mule-user-guide/v/4.0/dataweave-core-functions#subtracting-two-dates[-] |('Localdatetime', 'Localdatetime')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#append-time-zone[++] |('Localdatetime', 'Timezone')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[+] |('Localdatetime', 'Period')
| link:/mule-user-guide/v/4.0/dataweave-core-functions#adding-a-period-of-time[-] |('Localdatetime', 'Period')
|===
